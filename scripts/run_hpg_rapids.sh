...
#SBATCH --partition=hpg-b200          # The  hpg-b200 for B200 GPU partition on HPG, also HPG-turin for L4s
#SBATCH --gpus=b200:1                 # Request 1 B200 GPU b200:1, or 1 L4 l4:1
...
# Batch sizes power of 2's  B200s: #65536,32768, 16384, L4s: 16384,8192,4096, 2048
